...
export const listUsers = () => async (dispatch, getState) => {
  ...
  export const deleteUser = (userId) => async (dispatch, getState) => {
    ...
    try {const { data } = await Axios.delete(`/api/users/${userId}`, { headers: { Authorization: `Bearer ${userInfo.token}` }});
  ...
  // create update user action with admin 
