...
const Rating = (props) => {
    ...
    return (
        ...
        <span >
        <i className={rating >= 4 ? 'fas fa-star' : rating >= 3.5  ? 'fas fa-star-half-alt' : 'fas fa-star-o'}></i>
        </span>  

        <span >
        <i className={rating >= 5 ? 'fas fa-star' : rating >= 4.5  ? 'fas fa-star-half-alt' : 'fas fa-star-o'}></i>
        </span>  
