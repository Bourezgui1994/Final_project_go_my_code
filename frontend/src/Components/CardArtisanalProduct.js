...
const CardArtisanalProduct = (props) => {
    const {product} =props
    return (
        ...
        <div >
            ...
            <img src={product.image} alt={product.name}  height="130"/> 
                ...
                <Link to={`/ArtisanalProductDetailsScreen/${product._id}`} className="card-title" > <h5 > {product.name} </h5> </Link>
               ...
               <Rating rating={product.rating} numReviews={product.numReviews}/>
                ...
                <Link to={`/ArtisanalProductDetailsScreen/${product._id}`}>  <FaSearch size='1rem' color='black' /> </Link>
...
export default CardArtisanalProduct
