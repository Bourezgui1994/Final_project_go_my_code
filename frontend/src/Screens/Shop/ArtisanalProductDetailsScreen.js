...
import {detailsProduct} from '../../actions/artisanalActions'



    const ArtisanalProductDetailsScreen = (props) => {
    ...
    const addToCartHandler = () =>{
        props.history.push(`/cartArtisanal/${productId}?qty=${qty}`)
    }
    return (
...
export default ArtisanalProductDetailsScreen;
