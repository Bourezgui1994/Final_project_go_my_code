...
import { addToCart, removeFromCart } from '../../actions/cartArtisanalActions';
import IconSeperator from '../../Components/IconSeperator';
import MessageBox from '../../Components/MessageBox';
import './Cart.css';

const CartArtisanalScreen = (props) => {
                    ...
                    : (
                        ...
                        <table className="table">
                           ...
                           {cartItems.map((item) => 
                              ...
                              <Link to={`/ArtisanalProductDetailsScreen/${item.product}`}> {item.name}</Link>
...
export default CartArtisanalScreen;
