...
import { addToCart, removeFromCart } from '../../actions/cartAccessoryActions';
import IconSeperator from '../../Components/IconSeperator';
import MessageBox from '../../Components/MessageBox';
import './Cart.css';

const CartAccessoryScreen = (props) => {
                    ...
                    : (
                        ...
                        <table className="table">
                           ...
                           {cartItems.map((item) => 
                              ...
                              <Link to={`/AccessoryProductDetailsScreen/${item.product}`}> {item.name}</Link>
...
export default CartAccessoryScreen;
