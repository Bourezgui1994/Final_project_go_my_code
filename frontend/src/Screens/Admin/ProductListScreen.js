...
import { createdLocalProducts, deleteProduct, listProducts } from '../../actions/productActions';
...
const ProductListScreen = (props) => {
    ...
    useEffect(() => {
      if (successCreate) {
        ...
        props.history.push(`/LocalProductDetailsScreen/${createdProduct._id}/edit`);
      }
             ...
             <table className="table table-striped table-hover mt-5 ">
                ...
                {products.map((product) => (
                    <tr key={product._id}>
                      ...
                      <td>{product.brand}</td>
                      <td>
                        <button type="button" className="btn-sm btn-warning mx-3" onClick={() => props.history.push(`/LocalProductDetailsScreen/${product._id}/edit`)}>
