...
import { detailsProduct, updateProduct } from '../../actions/artisanalActions';
import IconSeperator from '../../Components/IconSeperator';
import LoadingBox from '../../Components/LoadingBox';
import MessageBox from '../../Components/MessageBox';
import { PRODUCT_UPDATE_RESET } from '../../constants/productConstants';

const ProductEditArtisanalScreen = (props) => {
    ...
    useEffect(() => {
        ...
        if (successUpdate) {
          props.history.push('/productlistArtisanal');
        }
...
export default ProductEditArtisanalScreen;
